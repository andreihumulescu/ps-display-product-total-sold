# PrestaShop Display Product Total SOld

## Description

PrestaShop module that displays the number of sold products \
Tested with PrestaShop 8 / 9 and PHP 8.1 / 8.3
...
Once the module has been successfully installed, a 'Total Sold' column will be displayed when accesing the product listing as shown below \
![image](screenshots/total_sold_column.png)
...
[1]: https://github.com/andreihumulescu/ps-display-product-total-sold/releases
